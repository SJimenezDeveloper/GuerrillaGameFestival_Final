    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        void UpdateCharacterHeight(bool force)
        {
            ...
            if (force)
            {
                ...
                PlayerCamera.transform.localPosition = new Vector3(0, m_TargetCharacterHeight * CameraHeightRatio, 0.7f);
            ...
            else if (m_Controller.height != m_TargetCharacterHeight)
            {
                ...
                m_Controller.center = Vector3.up * m_Controller.height * 0.5f;
                PlayerCamera.transform.localPosition = Vector3.Lerp(PlayerCamera.transform.localPosition, new Vector3(0, m_TargetCharacterHeight * CameraHeightRatio, 0.7f), CrouchingSharpness * Time.deltaTime);
                m_Actor.AimPoint.transform.localPosition = m_Controller.center;
            }
        }
