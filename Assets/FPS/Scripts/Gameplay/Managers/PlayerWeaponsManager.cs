...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        public bool IsPointingAtAlly {  get; private set; }
            ...
            if (activeWeapon)
            {
                    ...
                    1000, -1, QueryTriggerInteraction.Ignore))
                {
                    if (hit.collider.GetComponentInParent<Health>() != null)
                    {
                        ...
                        if (hit.collider.gameObject.GetComponentInParent<Actor>() == null)
                        {
                            Debug.Log("no es un actor");
                        }
                        else if (hit.collider.gameObject.GetComponentInParent<Actor>().Affiliation == 0)
                        {
                                
                            Debug.Log("apuntando a un enemigo");
                                IsPointingAtEnemy = true;
                        }
                        else if (hit.collider.gameObject.GetComponentInParent<Actor>().Affiliation == 1)
                        {

                            Debug.Log("apuntando a un aliado");
                            IsPointingAtAlly = true;
                        }
